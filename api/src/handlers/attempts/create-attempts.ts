...
export async function createAttempts (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
    try {
        ...
        */
        return await createAttemptLogic(event)
    } catch (err) {
