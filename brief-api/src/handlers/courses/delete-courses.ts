...
export async function deleteCourses (event: APIGatewayProxyEvent): Promise<APIGatewayProxyResult> {
    try {
        ...
        */
        ...
        // check for being at least an instructor
        return await deleteCoursesLogic(event)
    } catch (err) {
